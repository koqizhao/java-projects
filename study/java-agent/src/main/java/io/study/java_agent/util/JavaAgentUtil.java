...
public class JavaAgentUtil {
    ...
    private static Logger _logger = LoggerFactory.getLogger(JavaAgentUtil.class);
    ...
    public static boolean loadAgent(Class<?> agentClass, String agentArgs) {
        ...
        return JavaAgentUtil.loadAgent(agentJar, agentArgs);
    }
    ...
    private static void tryInit() {
        ...
        synchronized (JavaAgentUtil.class) {
            if (_initSuccess != null)
                return;
